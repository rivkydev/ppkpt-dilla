    ...
    <div class="flex mt-31">
            ...
            <div class="bg-[#E0DEDE] rounded-lg shadow-lg lg:mx-4 mx-2 w-[100%] lg:md:h-[calc(100vh-120px)] p-2 overflow-y-auto">
                ...
                <table class="min-w-full bg-white border border-gray-300 text-sm">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left font-semibold font-roboto">Level Penanganan</th>
                        <th class="px-6 py-3 text-left font-semibold font-roboto">Nilai Preferensi</th>
        ...
        (
            '{{ strtolower($aduan->kode_aduan) }}'.includes(search.toLowerCase())
                                ...
                                <td class="px-6 py-4 font-semibold text-gray-800 kodeAduan">
                                    {{ $aduan->kode_aduan }}
                                </td>
                                ...
                                @php
                                    ...
                                    $currentStatus = $status
                                        ? ($status->label5 ?? $status->label4 ?? $status->label3 ?? $status->label2 ?? $status->label1)
                                        : null;
                                @endphp
