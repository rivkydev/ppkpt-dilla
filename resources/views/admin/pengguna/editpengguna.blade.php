            ...
            <form action="{{ route('admin.editpengguna.update', $user->id) }}" method="POST">
                ...
                <div class="flex flex-col gap-4 w-full">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center gap-2 w-full">
                        ...
                        <div class="flex-1">
                            <h6 class="font-bold">{{ ucfirst($user->role) }}</h6>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center gap-2 w-full">
                        ...
                        <div class="flex-1">
                            <input
                                ...
                                value="{{ old('nim_nidn') ?? $user->nim_nidn }}"   
                            >
                            @error('nim_nidn')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="flex flex-col md:flex-row md:items-center gap-2 w-full">
                        ...
                        <div class="flex-1">
                            ...
                            >
                                ...
                                <option value="Dosen" {{ old('status', $user->status) == 'Dosen' ? 'selected' : '' }}>Dosen</option>
                                <option value="Tenaga Pendidik" {{ old('status', $user->status) == 'Tenaga Pendidik' ? 'selected' : '' }}>Tenaga Pendidik</option>
                                <option value="Satpam" {{ old('status', $user->status) == 'Satpam' ? 'selected' : '' }}>Satpam</option>
                                <option value="OB" {{ old('status', $user->status) == 'OB' ? 'selected' : '' }}>OB</option>
