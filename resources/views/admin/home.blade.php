    ...
    <div class="flex mt-31">
      ...
      <div class="w-[300px] bg-[#F08619] px-4 py-15 shadow-lg rounded-lg lg:block hidden">
            ...
            <div class="bg-[#E0DEDE] rounded-lg shadow-lg lg:mx-4 mx-2 w-[100%] h-screen p-5 overflow-y-auto">
                ...
                <div class="mb-6">
                    <h2 class="text-2xl font-bold text-gray-800 border-l-4 border-[#0970A5] pl-3">Dashboard Admin</h2>
                    <p class="text-gray-600 mt-1">Ringkasan status pelaporan yang masuk ke sistem PPKPT ITH.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6 border-b-4 border-[#0970A5] hover:shadow-lg transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-gray-500 font-semibold mb-1">Total Aduan</p>
                                <h3 class="text-3xl font-bold text-gray-800">{{ $totalAduan }}</h3>
                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6 border-b-4 border-yellow-500 hover:shadow-lg transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-gray-800">{{ $menungguVerifikasi }}</h3>
                            </div>
                    ...
                    <!-- Card 3 -->
                    <div class="bg-white rounded-xl shadow-md p-6 border-b-4 border-[#F08619] hover:shadow-lg transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-gray-500 font-semibold mb-1">Diproses Satgas</p>
                                <h3 class="text-3xl font-bold text-gray-800">{{ $diprosesSatgas }}</h3>
                            </div>
                            <div class="bg-orange-100 p-3 rounded-full text-[#F08619] w-12 h-12 flex items-center justify-center">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                        <h3 class="font-semibold text-gray-800">Aduan Terbaru</h3>
                        <a href="{{ route('admin.kelolaformulir') }}" class="text-sm text-[#0970A5] hover:underline font-medium">Lihat Semua</a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="text-sm divide-y divide-gray-100">
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" class="px-6 py-8 text-center text-gray-500">Belum ada aduan yang masuk.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
